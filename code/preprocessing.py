...
def preprocessing(sigma: float,
    ...
    I0 = sci.ndimage.gaussian_filter(plt.imread("../reference_frames/frame10.png", "png"), sigma)
    I1 = sci.ndimage.gaussian_filter(plt.imread("../reference_frames/frame11.png", "png"), sigma)
